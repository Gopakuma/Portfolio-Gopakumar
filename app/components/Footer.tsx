...
function Footer() {
    return (
        <footer className="footer footer-center bg-base-100 text-base-content rounded p-5 shadow-xl">
            <div className=" bg-clip-text bg-gradient-to-r from-pink-500 to-violet-500 
                                font-extrabold text-transparent">
                <h1 className="
                xs-mobile:text-xl text-center 
                2xl:text-6xl tracking-wide hover:tracking-widest duration-1000
                font-bold m-5 p-5"
                >Lets Connect...!</h1>
                <div className="grid grid-cols-2 items-center xs-mobile:text-xs gap-2">
            ...
            <aside>
                <p className="xs-mobile:text-xs">Copyright © {new Date().getFullYear()} - All right reserved by Baba Yaga</p>
            </aside>
        </footer>
    )
}
